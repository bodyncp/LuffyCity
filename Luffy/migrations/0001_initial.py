# Generated by Django 2.0.5 on 2018-06-19 13:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('complete', models.BooleanField(choices=[(0, 'no'), (1, 'yes')], verbose_name='是否完成任务')),
            ],
        ),
        migrations.CreateModel(
            name='Team',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modules', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Luffy.Module', verbose_name='所属模块')),
                ('summarys', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='Luffy.Summary', verbose_name='用户总结')),
                ('teams', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Luffy.Team', verbose_name='所属小组')),
